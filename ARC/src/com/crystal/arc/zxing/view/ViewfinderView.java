package com.crystal.arc.zxing.view;
...
public final class ViewfinderView extends View {
	...
	private final int possibleResultPointColor;
	...
	public ViewfinderView(Context context, AttributeSet attrs) {
		...
		possibleResultPointColor = resources.getColor(R.color.possible_result_points);
		resultPointColor = resources.getColor(R.color.result_points);
		scannerAlpha = 0;
...
//			scannerAlpha = (scannerAlpha + 1) % SCANNER_ALPHA.length;
			paint.setColor(resultPointColor);
			int heightMiddle = frame.height() / 2 + frame.top;
			int widthMiddle = frame.width() / 2 + frame.left;
//			canvas.drawRect(frame.left + 2, heightMiddle - 1, frame.right - 1,
//					heightMiddle + 2, paint);
//			canvas.drawRect(widthMiddle - 1, frame.top + 2, widthMiddle + 2,
//					frame.bottom - 1, paint);
			// 横线
			canvas.drawRect(widthMiddle - 20, heightMiddle - 1,
					widthMiddle + 20, heightMiddle + 2, paint);
			// 竖线
			canvas.drawRect(widthMiddle - 1, heightMiddle - 20,
					widthMiddle + 2, heightMiddle + 20, paint);
